...
public class BinaryTree_Lat1 {
    public Node root;
    public BinaryTree_Lat1() {
        root = null;
    }
    ...
    public static void main(String[] args) {
        BinaryTree_Lat1 tree = new BinaryTree_Lat1();
        ...
        tree.root.left.right = new Node(12); // Menambahkan node ke kiri dari node kanan root
